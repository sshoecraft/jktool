...
PROG=jktool$(EXT)
SRCS=main.c jk_info.c jk.c parson.c list.c utils.c cfg.c daemon.c module.c ip.c serial.c bt.c can.c 
...
zip: $(PROG)
	rm -f jktool_$(TARGET)_static.zip
	zip jktool_$(TARGET)_static.zip $(PROG)
